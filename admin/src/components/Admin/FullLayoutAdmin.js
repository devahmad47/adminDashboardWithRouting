...
// custom hook in react without importing actual component an hook is export to another component camelcase is neccsesry 
export const AdminLayout = () => {
  ...
  const toggelDropDown = (index) => {
    const updatedState = menuItems.map(() => false);
  ...
  return (
    <>
      <div className="antialiased bg-gray-50 dark:bg-white-600">
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-purple-600 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex justify-start items-center">
              ...
              >
                <img src={logo} className="mr-3 h-8" alt="Gravity Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
                  GRAVIT'Y
                </span>
              </a>
              <form action="#" method="GET" className="hidden md:block md:pl-2">
                <label for="topbar-search" className="sr-only bg-stone-900">
                  Search
                </label>
                <div className="relative md:w-64 md:w-96">
                  <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                    <svg
                      className="w-5 h-5 text-gray-500 dark:text-stone-900"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                  ...
                  <input
                    ...
                    name="email"
                    id="topbar-search"
                    className="bg-gray-50 border border-gray-300 text-stone-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-700 dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search"
                  />
                </div>
              </form>
        ...
        <aside
          className="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full border-r border-gray-200 md:translate-x-0 bg-purple-600 dark:border-gray-700"
          aria-label="Sidenav"
        ...
        >
          <div className="overflow-y-auto py-5 px-3 h-full dark:bg-purple-600">
            ...
            <ul className="pt-2 mt-3 space-y-2 border-t border-gray-200 dark:border-gray-700">
              <li>
                <a
                  href="/"
